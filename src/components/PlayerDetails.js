    ...
    return (
        ...
        <div className='DivDetailsPlayer'>
            ...
            <ul className='FeaturesPlayerUl'>
                <li className='PlayersFeaturesLi'><b>Nombre:</b> {playerDetails[0]?.player?.firstname}</li>
                <li className='PlayersFeaturesLi'><b>Apellido:</b> {playerDetails[0]?.player?.lastname}</li>
                <li className='PlayersFeaturesLi'><b>Edad:</b> {playerDetails[0]?.player?.age} años</li>
                <li className='PlayersFeaturesLi'><b>Altura:</b> {playerDetails[0]?.player?.height}</li>
                <li className='PlayersFeaturesLi'><b>Peso:</b> {playerDetails[0]?.player?.weight}</li>
                <li className='PlayersFeaturesLi'><b>Nacionalidad:</b> {playerDetails[0]?.player?.nationality}</li>
                <li className='PlayersFeaturesLi'><b>Numero:</b> {idPlayNumber[0]?.players[0]?.number}</li>
            </ul>
        </div>
        <div className='DivDetailsPlayerTwo'>
            {playerDetails[0]?.statistics[0]?.games?.position === "Goalkeeper" &&
                <ul className='FeaturesPlayerUlTwo'>
                    ...
                    <li className='PlayersFeaturesLi'><b>Goles recibidos:</b> {playerDetails[0]?.statistics[0]?.goals?.conceded}</li>
                    <li className='PlayersFeaturesLi'><b>Remates atajados:</b> {playerDetails[0]?.statistics[0]?.goals?.saves}</li>
                    <li className='PlayersFeaturesLi'><b>Duelos ganados:</b> {playerDetails[0]?.statistics[0]?.duels?.won}</li>
                    <li className='PlayersFeaturesLi'><b>Faltas cometidas:</b> {playerDetails[0]?.statistics[0]?.fouls?.committed === null ? "0" : playerDetails[0]?.statistics[0]?.fouls?.committed}</li>
                    ...
                    <li className='PlayersFeaturesLi'><b>Penaltis atajados:</b> {playerDetails[0]?.statistics[0]?.penalty?.saved}</li>
